...
var browseButtons = "<div id='browse-nav'>\n<div id='browse-back' class='nav-button'><a href='#' onclick='return showBrowsePanel()'><span class='entry-url'></span></a>\n< Back\n</div><div class='nav-button second-absolute-button'><a href='#' onclick='return saveFeed(this, feedSelection[0], false)'><span class='entry-url'></span></a>Add to My Feed</div></div>";
