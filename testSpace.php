...
$url = "https://petapixel.com/2017/10/09/color-correct-one-click-photoshop/";

$page = getPageContents($url);

$image = getSiteIconURL($page);

echo validateImageLink($image);
...
function getSiteIconURL($pageContents) {
  ...
  // Arriving here indicated that the URL was not found in the Schema.org
